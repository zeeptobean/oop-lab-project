...
void UIBookCard::draw() {
    if(!book) return;
    ImGui::PushID(this); 
    ImGui::BeginChild("BookCard", ImVec2(-1, 180.0f), true, ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoScrollWithMouse);
    ImGui::ImageNonStretch(texture, 120.0f, 160.0f, appContext.darkMode);
    ImGui::SameLine();
